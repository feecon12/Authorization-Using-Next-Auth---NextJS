        ...
        <>
            <motion.div
                ...
                <form className='mt-8 w-[300px]  flex-col items-left mb-8 border p-8 shadow-lg rounded-xl'>
                    ...
                    <p className='mt-2 mx-auto text-[8px] items-center justify-between'>Password must be atleast 8 characters long and contains atleast 1 uppercase letter, 1 number, and one of these special characters: @$%*?&</p>
